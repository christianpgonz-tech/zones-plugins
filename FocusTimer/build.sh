#!/bin/bash
# Builds FocusTimer.zone and FocusTimer.zip (the file you put on your website).
set -e
cd "$(dirname "$0")"
NAME=FocusTimer
SRC="FocusTimerModel.swift FocusTimerZone.swift FocusTimerSettings.swift FocusTimerChip.swift"
