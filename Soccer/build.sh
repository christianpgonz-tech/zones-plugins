#!/bin/bash
# Builds Soccer.zone and Soccer.zip (the file you put on your website).
set -e
cd "$(dirname "$0")"
NAME=Soccer
SRC="../Shared/SportsPicker.swift SoccerPicker.swift SoccerData.swift SoccerViews.swift SoccerWindow.swift SoccerAlert.swift SoccerChip.swift SoccerZone.swift"
