#!/bin/bash
# Builds CollegeFootball.zone and CollegeFootball.zip (the file you put on your website).
set -e
cd "$(dirname "$0")"
NAME=CollegeFootball
SRC="../Shared/SportsPicker.swift CollegePicker.swift CollegeData.swift CollegeViews.swift CollegeWindow.swift CollegeAlert.swift CollegeChip.swift CollegeZone.swift"
