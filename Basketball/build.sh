#!/bin/bash
# Builds Basketball.zone and Basketball.zip (the file you put on your website).
set -e
cd "$(dirname "$0")"
NAME=Basketball
SRC="../Shared/SportsPicker.swift BasketballPicker.swift BasketballData.swift BasketballViews.swift BasketballWindow.swift BasketballAlert.swift BasketballChip.swift BasketballZone.swift"
